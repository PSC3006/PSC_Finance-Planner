...
"@)
    ...
    $script:divCalPanels   = [System.Collections.ArrayList]::new()

    for ($mi = 0; $mi -lt 12; $mi++) {
        # Kachel als TableLayoutPanel: Monatsname (oben), Monatssumme, scrollbarer Inhalt (fuellt Rest).
        # FIX: Frueher feste Label-Hoehe (65 px) schnitt die Liste ab, sobald mehrere Wertpapiere
        #      im selben Monat ausschuetteten (z. B. alle "jaehrlich"-Titel im Dezember). Durch den
        #      scrollbaren Bereich werden jetzt ALLE Eintraege angezeigt.
        $tile = New-Object System.Windows.Forms.TableLayoutPanel
        $tile.Dock = "Fill"; $tile.BorderStyle = "FixedSingle"; $tile.Margin = New-Object System.Windows.Forms.Padding(3)
        $tile.ColumnCount = 1; $tile.RowCount = 3
        $tile.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 100))) | Out-Null
        $tile.RowStyles.Add((New-Object System.Windows.Forms.RowStyle([System.Windows.Forms.SizeType]::Absolute, 24))) | Out-Null
        $tile.RowStyles.Add((New-Object System.Windows.Forms.RowStyle([System.Windows.Forms.SizeType]::Absolute, 22))) | Out-Null
        $tile.RowStyles.Add((New-Object System.Windows.Forms.RowStyle([System.Windows.Forms.SizeType]::Percent, 100))) | Out-Null
        ...
        $mLbl.Dock = "Fill"; $mLbl.TextAlign = "MiddleCenter"; $mLbl.BackColor = [System.Drawing.Color]::Transparent

        $aLbl = New-Object System.Windows.Forms.Label
        $aLbl.Dock = "Fill"; $aLbl.TextAlign = "MiddleRight"
        $aLbl.Padding = New-Object System.Windows.Forms.Padding(0,0,8,0)
        ...
        $cPanel = New-Object System.Windows.Forms.Panel
        $cPanel.Dock = "Fill"; $cPanel.AutoScroll = $true; $cPanel.Margin = New-Object System.Windows.Forms.Padding(0)

        $cLbl = New-Object System.Windows.Forms.Label
        $cLbl.Location = New-Object System.Drawing.Point(5,2)
        $cLbl.AutoSize = $true
        $cLbl.MaximumSize = New-Object System.Drawing.Size(300,0)
        $cLbl.ForeColor = [System.Drawing.Color]::FromArgb(40,40,40)
        $cLbl.BackColor = [System.Drawing.Color]::Transparent
        $cPanel.Controls.Add($cLbl)

        $tile.Controls.Add($mLbl,   0, 0)
        $tile.Controls.Add($aLbl,   0, 1)
        $tile.Controls.Add($cPanel, 0, 2)
        ...
        $script:divCalPanels.Add($cPanel) | Out-Null
    }
    ...
    function Update-DividendeTab {
        ...
        for ($mi = 0; $mi -lt 12; $mi++) {
            ...
            $pnl = $script:divCalPanels[$mi]
            if ($divAmt -gt 0) {
                $tile.BackColor = [System.Drawing.Color]::FromArgb(235,248,235)
                $pnl.BackColor  = [System.Drawing.Color]::FromArgb(235,248,235)
